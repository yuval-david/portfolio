                            ...
                            projectsArr.map((project) => {
                                ...
                                return (
                                    <SwiperSlide key={project.id}>
                                        <ProjectCard project_id={project.id} name={project.name} img={project.pre_img} credit={project.credit} video={project.pre_video} tools={project.tools} link={project.web_link} git={project.github} />
                                    </SwiperSlide>
                                )
                            })
                        }
